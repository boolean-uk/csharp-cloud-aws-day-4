...
public class OrderController : ControllerBase
{
    ...
    private readonly string _queueUrl = "https://sqs.eu-north-1.amazonaws.com/637423341661/danielmjosroliOrderQueue"; // Format of https://.*
    private readonly string _topicArn = "arn:aws:sns:eu-north-1:637423341661:danielmjosroliOrderCreatedTopic"; // Format of arn:aws.*

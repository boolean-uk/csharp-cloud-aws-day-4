...
public class OrderController : ControllerBase
{
    ...
    private readonly string _queueUrl = "https://sqs.eu-north-1.amazonaws.com/637423341661/andersHagenOrderQueue"; // Format of https://.*
    private readonly string _topicArn = "arn:aws:sns:eu-north-1:637423341661:andersHagenOrderCreatedTopic"; // Format of arn:aws.*
